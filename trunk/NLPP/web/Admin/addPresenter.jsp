            ...
            <div class="main_content">
                ...
                <div class="center_content">
                    ...
                    <div class="right_content">
                        <h2><img alt="NLPP's Site"  src="images/icon_cube.png" width="64" height="95"/>Add Presenter <span>Form</span></h2>
                        <div class="form">
                            <form id="form" action="../AdminPresenterCO?action=addpresenter" method="post" >
                                <fieldset>
                                    <dl>
                                        <dt><b>FullName:</b></dt>
                                        <dd><input type="text" name="txtname" id="" size="54"  /></dd>
                                    </dl>
                                    <dl>
                                        <dt><b>Email:</b></dt>
                                    ...
                                    <dl>
                                        ...
                                        <dd><input type="text" name="txtphone" id="" size="54" /></dd>
                                    </dl>
                                    <dl>
                                        <dt><b>Address:</b></dt>
                                        <dd><textarea name="txtaddress" id="comments" rows="8" cols="60"></textarea></dd>
                                    </dl>
                                    <dl class="submit">
                                        <input type="reset" value="Reset Form"/>||<input type="submit" name="submit" id="submit" value="Add Presenter" />
                                    </dl>
                                </fieldset>
