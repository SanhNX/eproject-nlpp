        ...
        <div class="wrap">
            ...
            <div class="container">
                ...
                <section id="content">
                    ...
                    <div class="inside">
                        <h2><img alt="NLPP'Site" src="images/icon_cube.png" width="64" height="95">Subscribe <span> Error</span></h2>
                        <ul class="articles">
                            <h3><span class="txt1" style="color: red;">${requestScope.mailing.email}</span>
                                <span class="txt1">had already used </span></h3>
                            <br/>
                            <h3><span class="txt1" style="color: red;" >Please try Again !! </span></h3>
                            <br/>
                            <div align="center">
                                <form action="VisiterCO?action=addMail" method="POST" id="contacts-form">
                                    <table cellpadding="110" cellspacing="15">
                                        <tr class="field">
                                            <td>Your E-mail &nbsp;</td>
                                            <td>
                                                <input type="text" name="txtMailing" size="30">
                                            </td>
                                        </tr>
                                        <tr class="field">
                                            <td></td>
                                            <td><input align="right" type="submit" value="Subscribe Now"></td>
                                        </tr>
                                    </table>
                                </form>
                            </div>
